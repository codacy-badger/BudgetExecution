...
namespace Budget
{
    namespace Ninja
    {
        namespace Data
        {
            public partial class SummForm : MetroForm
            {
                ...
                {
                    return new ChartControl[] { FundChart, FundChart, NpmChart, GoalChart, ObjectiveChart, DivisionChart, AreaChart, ProjectChart };
                }
                ...
                private TabPageAdv[] GetTabs()
                {
                    try
                    {
                        var tabs = new TabPageAdv[] {FundTab, BocTab, NpmTab, GoalTab, ObjectiveTab,
