// <copyright file="SqlServerData.cs" company="PlaceholderCompany">
...
namespace BudgetExecution
{
    ...
    public sealed partial class SqlServerData : MetroForm
    {
        // CONSTRUCTORS
        ...
        public SqlServerData(Source source, Provider provider)
        {
            InitializeComponent();
            Source = source;
            Provider = provider;
