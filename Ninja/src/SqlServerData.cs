// <copyright file="SqlCeData.cs" company="PlaceholderCompany">
...
namespace BudgetExecution
{
    ...
    public partial class SqlServerData : MetroForm
    {
        // CONSTRUCTORS
        ...
        private void SqlServerData_Load(object sender, EventArgs e)
        {
            this.SqlServerTableAdapter.Fill(this.SqlServer.PRC);
